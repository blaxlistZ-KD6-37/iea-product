...
func main() {
	...
	A1_rtr.Post("/runlive/transaction", database_handler.handlerPostTransaction)
	A1_rtr.Post("/runlive/transaction_detail", database_handler.handlerPostTransactionDetail)
